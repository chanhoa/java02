...
public class Run {
    ...
    private static void testPreparedStatement() {
        try (
            ...
            preparedStatement_insert.setString(4, "TrungAnh-testPreparedStatement"); //Name
    ...
    private static void testBatchProcessing() {
        try (
            ...
            statement.addBatch("INSERT INTO Book (IDCategory, IDAuthor, IDPublishCompany, Name, Price, Qty) VALUES (1, 1, 1, 'TrungAnh-testBatchProcessing-1', 650000, 656);");
            statement.addBatch("INSERT INTO Book (IDCategory, IDAuthor, IDPublishCompany, Name, Price, Qty) VALUES (1, 1, 1, 'TrungAnh-testBatchProcessing-2', 650000, 656);");
            statement.addBatch("INSERT INTO Book (IDCategory, IDAuthor, IDPublishCompany, Name, Price, Qty) VALUES (1, 1, 1, 'TrungAnh-testBatchProcessing-3', 650000, 656);");
    ...
    private static void testBatchProcessing_usePreparedStatement() {
        try (
            ...
            preparedStatement.setString(4, "TrungAnh-testBatchProcessing_usePreparedStatement"); //Name
